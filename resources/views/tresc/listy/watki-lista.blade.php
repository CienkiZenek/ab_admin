...
@section('tresc')
    ...
    <div class="row mt-2">
        ...
        <div class="col-6">
            <form action="{{route('watkiSzukaj')}}" method="get">
        ...
        <div class="col-6">
            <a href="{{route('watekNowy')}}" class="btn btn-primary" role="button" aria-pressed="true">Dodaj nowy wątek</a>
        </div>
    </div>
