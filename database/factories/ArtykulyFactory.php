...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Artykuly>
 */
class ArtykulyFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'motto' => $this->faker->text(100),
            'motto_podpis' => $this->faker->text(50),
