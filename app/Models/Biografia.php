...
class Biografia extends Model
{
    ...
    protected $fillable =['tytul', 'rodzaj', 'naglowek', 'tresc', 'gatunek', 'dzial', 'etap', 'autor', 'status', 'zdjecie1', 'zdjecie2',
        'zdjecie1_podpis', 'zdjecie2_podpis', 'zdjecie1_id', 'zdjecie2_id', 'ramka1', 'ramka2', 'cytat1', 'cytat2', 'cytat3', 'cytat4',   'title', 'keywords', 'description'];
